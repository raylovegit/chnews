...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div style='float:left'> <img height="14" src="${ctx}/skin/images/frame/book1.gif" width="20" />&nbsp;欢迎使用内容管理系统，建站的首选工具。 </div>
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
  <tr>
    <td colspan="2" background="${ctx}/skin/images/frame/wbg.gif" bgcolor="#EEF4EA" class='title'>
  ...
  <tr bgcolor="#FFFFFF">
    <td height="30" colspan="2" align="center" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          <td width="15%" height="31" align="center"><img src="${ctx}/skin/images/frame/qc.gif" width="90" height="30" /></td>
          <td width="85%" valign="bottom"><div class='icoitem'>
              <div class='ico'><img src='${ctx}/skin/images/frame/addnews.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>文档列表</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='${ctx}/skin/images/frame/menuarrow.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>评论管理</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='${ctx}/skin/images/frame/manage1.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>内容发布</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='${ctx}/skin/images/frame/file_dir.gif' width='16' height='16' /></div>
              <div class='txt'><a href=''><u>栏目管理</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='${ctx}/skin/images/frame/part-index.gif' width='16' height='16' /></div>
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td width="75%" bgcolor="#FFFFFF">${sessionScope.user.des}</td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td height="26">软件版本信息：</td>
    <td>Cms_2009_UTF8</td>
  </tr>
</table>
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><a href="http://www.hjj.hbnu.edu.cn" target="_blank"><u>http://www.hjj.hbnu.edu.cn</u></a></td>
  </tr>
</table>
</body>
</html>
