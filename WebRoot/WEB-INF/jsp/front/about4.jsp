...
<div id="rightBar2">
<div id="rightTop"><span><img src="${ctx}/skin/images/frame/news2_06.jpg" /></span><span style="color:#ff0000;font-size:16px;font:blod;">搜索结果</span></div>
<div id="rightDown">
<div id="biaoti"><span style=" float:right; padding-right:100px;">时间</span><span style="float:left; padding-left:100px;">主题</span><span style=" float:right; margin-right:200px;">点击量</span></div>
<div id="xinwen">
<ul>
<c:forEach items="${nlist}" var="n">
    <li><span style=" float:right; padding-right:40px;">${n.time }</span><span style="float:left;"><img src="${ctx}/skin/images/frame/news2_tb.gif" /><a href="${ctx}/FrontServlet?status=read&id=${n.id }">${n.title }</a></span><span style=" float:right; margin-right:200px;">${n.visitnum }</span></li>
</c:forEach>
</ul>
</div>
<div id="yemian">
<form action="${ctx}/FrontServlet?status=search" method="post">
