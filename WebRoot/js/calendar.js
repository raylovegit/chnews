...
strFrame+='</scr' + 'ipt>';
strFrame+='<div style="z-index:9999;position: absolute; left:0; top:0;" on_selectstart="return false"><span id=tmpSelectYearLayer Author=wayx style="z-index: 9999;position: absolute;top: 3; left: 19;display: none"></span>';
...
// 控件边框颜色
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=200 height=180 bgColor="#FFFFFF" borderColorLight=#7197CA borderColorDark="#ffffff"    Author="wayx">';
...
strFrame+='</table></td></tr><!-- Author:F.R.Huang(meizz) http://www.baidu.com/ mail: mail@163.com 2002-10-8 -->';
